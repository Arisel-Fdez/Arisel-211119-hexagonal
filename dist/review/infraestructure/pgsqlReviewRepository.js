...
class PgsqlReviewRepository {
    addReview(userId, bookId, msg) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const createdReview = yield reviewModel_1.default.create({ userId, bookId, msg });
                return new review_1.Review(createdReview.id, createdReview.userId, createdReview.bookId, createdReview.msg);
            }
            catch (error) {
    ...
    getAllReviews() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return reviews.map(review => new review_1.Review(review.id, review.userId, review.bookId, review.msg));
        });
    }
    deleteReviewById(id) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getReviewByUserId(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!review)
                return null;
            return new review_1.Review(review.id, review.userId, review.bookId, review.msg);
        });
    }
    updateReview(review) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (updateCount > 0) {
                    ...
                    if (updatedReviewData) {
                        return new review_1.Review(updatedReviewData.id, updatedReviewData.userId, updatedReviewData.bookId, updatedReviewData.msg);
                    }
                }
                return null;
            }
