...
class AuthController {
    ...
    logout(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const email = req.user.email; // Asumiendo que el email se almacena en req.user desde el middleware de autenticación
            yield this.authUseCase.deactivateUserSession(email);
            res.clearCookie('jwtToken'); // Si estás usando cookies para el JWT
